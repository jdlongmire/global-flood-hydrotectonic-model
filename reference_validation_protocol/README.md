...
**Version**: 0.3.1 (Global Flood Hydrotectonics Edition)
...
This protocol is integrated with the Global Flood Hydrotectonics research programme.

**Existing Citation Infrastructure:**
- `theory/literature/CITATION_VALIDATION_REPORT.md` - Validation status for all citations
- `theory/literature/CITATION_NEEDS.md` - Citations still needed
- `theory/literature/CATEGORY_*_CITATIONS.md` - Citations organized by topic

**Citation Categories for This Project:**
1. Core Geophysics & Mantle Studies (ringwoodite, tomography, water storage)
2. Rock Mechanics & Friction (Terzaghi, Byerlee, fault lubrication)
3. Tectonics & Structural Geology (detachments, fold-thrust belts)
4. Overpressure & Induced Seismicity (pore pressure, injection effects)
5. Sedimentology & Turbidites (submarine flows, hydroplaning)
6. Hypercane & Climate Physics (Emanuel 1994, heat transport)
7. Impact Events (trigger mechanisms)
